...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SILVER_ORE=BLOCKS.register("silver_ore",()-> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.5f,6f).harvestLevel(1).harvestTool(ToolType.PICKAXE)));
}
