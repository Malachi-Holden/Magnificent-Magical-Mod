...
//block item registry
    ...
    public static final RegistryObject<Item> BURNER_LIT= ITEMS.register("burner_lit", ()->new BlockItem(ModBlocks.BURNER_LIT.get(), (new Item.Properties()).maxStackSize(1)));
